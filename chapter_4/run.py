...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('THUCNews/saved_dict/grucell_NY.ckpt'))   # 加载预训练模型
    model.load_state_dict(torch.load('THUCNews/saved_dict/grucell_US_pretrain_1.2_0.045.ckpt'))
