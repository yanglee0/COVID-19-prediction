...
state_dict = torch.load('../THUCNews/saved_dict/grucell_US_1.3.ckpt')
...
important = softmax(weight2_mean.tolist()).tolist()    # 权重list

max_number = heapq.nlargest(5, important)
max_index = []
for t in max_number:
    index = important.index(t)
