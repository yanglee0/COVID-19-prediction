...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('THUCNews/saved_dict/grucell_IN_1.2.ckpt'))   # 加载预训练模型
    # model.load_state_dict(torch.load('THUCNews/saved_dict/US/grucell_US_noprain_1.2.ckpt'))
